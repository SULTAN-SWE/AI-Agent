  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Aggregated insights and strategic summaries generated by the operations AI.</p>
      </div>
        ...
        <DialogContent className="sm:max-w-[600px] bg-card border-border/50">
          ...
          <div className="mt-4 p-4 rounded-lg bg-primary/5 border border-primary/20">
            <h4 className="font-semibold text-primary mb-2 flex items-center gap-2">
              <TrendingUp className="w-4 h-4" /> AI Strategic Insight
            </h4>
